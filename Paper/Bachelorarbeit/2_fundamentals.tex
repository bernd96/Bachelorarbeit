...
Diese Neuerungen resultieren in einer veränderten \verb|EXTEND(T,x)| Funktion [TODO Literaturverweis Kap4 Alg6 Frazzoli].
\subsubsection{Funktionsweise RRT*}
\begin{lstlisting}
EXTEND(T,x)
