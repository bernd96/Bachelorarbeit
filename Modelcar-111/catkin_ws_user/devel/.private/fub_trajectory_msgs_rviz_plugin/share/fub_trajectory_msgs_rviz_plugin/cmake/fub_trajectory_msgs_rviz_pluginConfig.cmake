...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'fub_trajectory_msgs_rviz_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mi/besahre/Documents/Bachelorarbeit/Modelcar-111/catkin_ws_user/src/fub_trajectory_msgs_rviz_plugin/${idir}'.  ${_report}")
    endif()
